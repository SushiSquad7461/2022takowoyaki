...
public class Ramsete {
  ...
  public enum PathPlannerPath {
    ...
    SHOOT_WALL(PathPlanner.loadPath("shoot-wall", 6, 5, true)),
    WALL_TERMINAL(PathPlanner.loadPath("wall-terminal", 7, 3, false)),
    TERMINAL_WALL(PathPlanner.loadPath("terminal-wall", 5, 3, true)),
    WALL_SHOOT(PathPlanner.loadPath("wall-shoot", 6, 3, false)),
    TERMINAL_SHOOT(PathPlanner.loadPath("terminal-shoot", 7, 4, false)),
